...
UserEightCharModel userEightCharFromJson(String str) => UserEightCharModel.fromJson(json.decode(str));
String userEightCharToJson(UserEightCharModel data) => json.encode(data.toJson());
class UserEightCharModel  implements JsonSerializable  {
  UserEightCharModel({
      num? id, 
      num? userId, 
      num? year, 
  ...
  UserEightCharModel.fromJson(dynamic json) {
    _id = json['id'];
    _userId = json['userId'];
    _year = json['year'];
    _month = json['month'];
  ...
  String? _intro;
  String? _analyze;
UserEightCharModel copyWith({  num? id,
  num? userId,
  num? year,
  num? month,
  num? day,
