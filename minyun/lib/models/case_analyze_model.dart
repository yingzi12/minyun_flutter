...
CaseAnalyzeModel caseAnalyzeModelFromJson(String str) => CaseAnalyzeModel.fromJson(json.decode(str));
String caseAnalyzeModelToJson(CaseAnalyzeModel data) => json.encode(data.toJson());
class CaseAnalyzeModel  implements JsonSerializable{
  CaseAnalyzeModel({
      num? id, 
      num? userId, 
      num? year, 
  ...
  CaseAnalyzeModel.fromJson(dynamic json) {
    _id = json['id'];
    _userId = json['userId'];
    _year = json['year'];
    _month = json['month'];
  ...
  num? _caseType;
CaseAnalyzeModel copyWith({  num? id,
  num? userId,
  num? year,
  num? month,
  num? day,
  ...
  caseDescription: caseDescription ?? _caseDescription,
