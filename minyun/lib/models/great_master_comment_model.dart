...
GreatMasterCommentModel greatMasterCommentFromJson(String str) => GreatMasterCommentModel.fromJson(json.decode(str));
String greatMasterCommentToJson(GreatMasterCommentModel data) => json.encode(data.toJson());
class GreatMasterCommentModel implements JsonSerializable {
  GreatMasterCommentModel({
      num? id, 
      num? gaid, 
      String? ganame, 
      num? upid, 
  ...
  GreatMasterCommentModel.fromJson(dynamic json) {
    _id = json['id'];
    _gaid = json['gaid'];
    _ganame = json['ganame'];
    _upid = json['upid'];
...
GreatMasterCommentModel copyWith({  num? id,
  num? gaid,
  String? ganame,
  num? upid,
  String? comment,
  ...
  String? nickname,
  String? replyNickname,
}) => GreatMasterCommentModel(  id: id ?? _id,
  gaid: gaid ?? _gaid,
