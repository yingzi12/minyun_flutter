...
class AnalyzeEightCharInfoApi{
  // 类变量（静态变量）
  static String info ="/admin/minyun/analyzeEightCharInfo/info";

  static String list ="/admin/minyun/analyzeEightCharInfo/list";

  static String add ="/admin/minyun/analyzeEightCharInfo/add";

  static String del ="/admin/minyun/analyzeEightCharInfo/del";

  static String edit ="/admin/minyun/analyzeEightCharInfo/edit";
