          ...
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Text("Hello there", style: appMainBoldTextStyle(fontSize: 24)),
                    SizedBox(width: 8),
                ...
                GestureDetector(
                  ...
                  child: Text(
                    "Forgot Password",
                    style: appMainBoldTextStyle(color: primaryColor),
                  ),
                ),
                SizedBox(height: 24),
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("or continue with", style: appMainSecondaryTextStyle()),
                    ),
                    Expanded(child: Divider()),
                  ],
                ),
