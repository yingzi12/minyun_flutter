...
class HelpCenterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text("Help Center", style: appMainBoldTextStyle(fontSize: 24)),
          elevation: 0,
          iconTheme: IconThemeData(color: mode.theme ? Colors.white : Colors.black),
          bottom: TabBar(
            labelColor: primaryColor,
            labelStyle: appMainBoldTextStyle(fontSize: 18),
            unselectedLabelColor: Colors.grey,
            indicatorPadding: EdgeInsets.symmetric(horizontal: 16),
            unselectedLabelStyle: appMainPrimaryTextStyle(color: Colors.grey, fontSize: 16),
