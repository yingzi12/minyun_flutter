          ...
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Text("Create new password", style: appMainBoldTextStyle(fontSize: 24)),
                    SizedBox(width: 8),
                    ...
                    return AlertDialog(
                      ...
                      content: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 16),
                          Text("Your password has been successfully changed.", style: appMainSecondaryTextStyle(), textAlign: TextAlign.center),
                          SizedBox(height: 24),
                          AppButton(
                            text: "Go to Home",
                            onTap: () {
