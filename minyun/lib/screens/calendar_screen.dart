...
import 'package:minyun/component/calendar/hour_cell_component.dart';
...
class _CalendarScreenState extends State<CalendarScreen> {
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, int index) {
                        ...
                        return HourCellComponent(hour, lunar);
                      },
                    ),
                  ],
                ),
  ...
  Widget getYJ(Lunar lunar) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: Colors.grey,
        borderRadius: BorderRadius.circular(10.0), // 你可以根据需要调整半径大小
      ),
      padding: EdgeInsets.all(10.0), // 根据需要调整内边距大小
      child: Column(
        children: [
          BrnPairInfoTable(
            children: <BrnInfoModal>[
              BrnInfoModal(
                keyPart: CircleBackgroundText("宜", Colors.yellow, 30),
                valuePart: y,
              ),
              BrnInfoModal(
                keyPart: CircleBackgroundText("忌", Colors.red, 30),
                valuePart: j,
              ),
            ],
          ),
        ...
        Expanded(
          child: Container(
            ...
            child: Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: Center(
                child: Text("值日九星：" + lunar.getDayNineStar().toString()),
              ),
            ),
          ),
        ),
