...
import 'package:minyun/screens/splayed/splayed_figure_detail_book_screen.dart';
...
import 'package:minyun/screens/user/user_splayed_figure_detail_common_screen.dart';
import 'package:minyun/screens/user/user_splayed_figure_detail_info_screen.dart';
import 'package:minyun/utils/AppColors.dart';
import 'package:minyun/utils/AppCommon.dart';
import 'package:minyun/utils/images.dart';


class UserSplayedFigureDetailScreen extends StatefulWidget {
  final SplayedFigureFindModel search;
  UserSplayedFigureDetailScreen({required this.search});

  @override
  State<UserSplayedFigureDetailScreen> createState() => _UserSplayedFigureDetailScreenState();
}

class _UserSplayedFigureDetailScreenState extends State<UserSplayedFigureDetailScreen>  with TickerProviderStateMixin {

  List<String> tabsTiles=["基本","排盘","分析","古籍","资料","点评"];
              ...
              child: Padding(
                ...
                child:  TabBarView(
                  ...
                  children:  <Widget>[
                    ...
                    UserSplayedFigureDetailInfoScreen(
                      search: widget.search,
                    ),
                    UserSplayedFigureDetailCommonScreen(
                      search: widget.search,
                    ),
